...
public class Conexion {
    ...
    /* Se crea el objeto "BasicDataSource" fuera del método de conexión, para
    que no sea local al método y no se creen más instancias de conexión si ya
    existe una conexión creada. */
    private static BasicDataSource ds;

    // Método para crear la conexión
    public static DataSource getDataSource() {

        /* Se comprueba si la conexión es "null" (no existe) y en tal caso se
        crea, si ya existe, simplemente se devuelve. */
        if (ds == null) {
